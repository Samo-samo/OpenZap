...
class SharedPreferencesSettingsStore implements SettingsStore {
  ...
  static const _screenAwakeTimeoutKey = 'screen_awake_timeout';
  ...
  Future<AppSettings> load() async {
    ...
    return AppSettings(
      ...
      screenAwakeTimeout:
          ScreenAwakeTimeout.values.asNameMap()[prefs.getString(
            _screenAwakeTimeoutKey,
          )] ??
  ...
  Future<void> save(AppSettings settings) async {
    ...
    await prefs.setString(
      _screenAwakeTimeoutKey,
      settings.screenAwakeTimeout.name,
    );
